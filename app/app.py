...
def get_image():
    r = requests.get('https://api.giphy.com/v1/gifs/random?api_key='+GIPHY_API_KEY+'&tag=unicorns', headers={'Accept': 'application/json'})
    data = r.json()
...
<html>
    ...
    <body style="text-align:center; background: -webkit-gradient(linear, left top, left bottom, from(#ff8f2e), to(#ffb498)) fixed; background: -webkit-gradient(linear, left top, left bottom, from(#582eff), to(#ffb498)) fixed;">
        <br>
