...
<html>
    ...
    <body style="text-align:center; background: -webkit-gradient(linear, left top, left bottom, from(#ff8f2e), to(#ffb498)) fixed; background: -webkit-gradient(linear, left top, left bottom, from(#ff8f2e), to(#35c6ff)) fixed;">
        <br>
